  ...
  return (
    <section style={{ padding: '120px 0', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="fz-container" style={{ position: 'relative', textAlign: 'center' }}>
        <div className="fz-secthead fz-reveal" style={{ justifyContent: 'center', marginBottom: 28 }}>
          <span style={{ color: 'var(--fz-red)' }}>● HASTA LA PRÓXIMA VUELTA</span>
        </div>
        <h2 className="fz-h1 fz-reveal" style={{ fontSize: 'clamp(120px, 14vw, 200px)' }}>
          <span style={{ display: 'block' }}>VAMOS A</span>
          <span style={{ display: 'block', color: 'var(--fz-red)' }}>RODAR.</span>
        </h2>
        <div
          className="fz-reveal fz-reveal-d2"
          style={{ display: 'inline-flex', gap: 12, marginTop: 48, flexWrap: 'wrap', justifyContent: 'center' }}
        >
